...
void displayMatch(uint8_t addr)
{
  ...
  if (addr == 0x44)                      Serial.println("Nettigo NAM HECA - Heating Element Control Assembly");
  ...
  if ((addr == 0x30) || (addr == 0x32) || (addr == 0x34) || (addr == 0x36)) Serial.println("Maxim DS2482S-100 - I2C to One Wire bridge");
